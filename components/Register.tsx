...
const checkPasswordStrength = (password: string) => {
  ...
  if (score < 4)
    return { text: "Aceptable", color: "bg-warning", width: "66%" };
...
export const Register: React.FC<RegisterProps> = ({
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center bg-light p-4 position-relative">
      ...
      <div
        className="w-100 p-4 bg-white rounded-4 shadow-lg"
      ...
      >
        <div className="text-center mb-4">
          ...
          <p className="text-muted">
            Complete el formulario para acceder al portal.
          </p>
        </div>
          ...
          <div>
            <div className="d-flex align-items-center justify-content-between mb-1">
              ...
              <button
                ...
                onClick={() =>
                  speak(
                    "Por favor, escriba su nombre y apellidos en este campo.",
                  )
                }
                className="btn btn-link text-primary p-0"
                aria-label="Escuchar explicación sobre el nombre completo"
              >
          ...
          <div>
            <div className="d-flex align-items-center justify-content-between mb-1">
              ...
              <button
                ...
                onClick={() =>
                  speak(
                    "Escriba aquí su dirección de correo electrónico. Será su nombre de usuario para entrar a la plataforma.",
                  )
                }
                className="btn btn-link text-primary p-0"
          ...
          <div>
            <div className="d-flex align-items-center justify-content-between mb-1">
              ...
              <button
                ...
                onClick={() =>
                  speak(
                    "Vamos a crear una contraseña segura. Piense en ella como una llave secreta muy difícil de adivinar. Para que sea fuerte, debe tener al menos 8 caracteres y mezclar letras mayúsculas, minúsculas, números y símbolos, como el arroba o el signo de exclamación. Evite usar su nombre o fechas importantes. Por ejemplo, una contraseña como 'MiPerroLucas_2024!' es mucho más segura que 'lucas123'.",
                  )
                }
                className="btn btn-link text-primary p-0"
                aria-label="Escuchar explicación sobre cómo crear una contraseña segura"
              >
                <i className="fas fa-volume-up"></i>
              </button>
            </div>
            ...
            {password && (
              <div className="mt-2">
                ...
                <p
                  className={`text-end small fw-semibold mt-1 text-${passwordStrength.color.replace("bg-", "")}`}
                >
