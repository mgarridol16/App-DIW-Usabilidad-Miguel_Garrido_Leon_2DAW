...
export const AIAssistant: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorText =
        "El servicio de asistencia no está disponible. Inténtelo más tarde.";
          ...
          {messages.map((msg, index) => (
            ...
            >
              {msg.sender === "ai" && (
                ...
                >
                  <i className="fas fa-comment-dots small"></i>
                </div>
              )}
              <div
      ...
      <form onSubmit={handleSubmit} className="p-3 border-top bg-white">
        <div className="d-flex align-items-center gap-2">
          ...
          <input
            ...
            placeholder={
              isListening ? "Escuchando..." : "Escriba su consulta..."
            }
